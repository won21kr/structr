...
/**
 */
public class BPMNStepsProperty extends AbstractReadOnlyProperty<Object> {

	private static final Logger logger = LoggerFactory.getLogger(BPMNStepsProperty.class);

	public BPMNStepsProperty(final String name) {
		super(name);
	}
	...
	public Object getProperty(SecurityContext securityContext, GraphObject obj, boolean applyConverter, Predicate<GraphObject> predicate) {
		...
		if (obj instanceof BPMNProcess) {
			...
			return ((BPMNProcess)obj).getSteps();
		}
